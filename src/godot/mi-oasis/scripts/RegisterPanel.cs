...
public partial class RegisterPanel : PanelContainer
{
	...
	public void _on_button_reg_register_pressed()
	{
		GD.Print("Registrar jugador ...");
	}
	
	public void _on_button_reg_back_pressed()
	{
		GD.Print("Regresar al login ...");
